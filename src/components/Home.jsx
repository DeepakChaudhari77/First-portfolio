...
import pic from "../../public/HeroImage01.png";
    ...
    <>
      <div name="Home" className="max-w-screen-2xl container mx-auto px-4 md:px-20 mt-20 mb-8">
        <div className="flex flex-col md:flex-row">
            ...
            <div className="flex justify-between items-center  flex-col md:flex-row">
              <div className="space-y-2 flex flex-col items-center mt-5 md:items-start" >
                ...
                <ul className="flex space-x-5 ">
                    <li>
                      <a href="https://www.linkedin.com/in/deepak-chaudhari-513b5a261/" target="_blank">
                        <FaLinkedin size={20} className="cursor-pointer" />
                      </a>
                    </li>
                    <li>
                      <a href="https://github.com/DeepakChaudhari77" target="_blank">
                        <FaGithub size={20} className="cursor-pointer" />
                      </a>
                    </li>
                    <li>
                      <a href="https://www.instagram.com/_deepak._dev_/" target="_blank">
          ...
          <img src={pic} alt="Personal Image" className="rounded-full object-cover md:w-[450px] md:h-[450px]" />
          </div>
        </div>
      </div>
      <br />
